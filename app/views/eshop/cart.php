...
<section id="cart_items" style="margin-top: -50px;">
	<div class="container">
		...
		<div class="table-responsive cart_info" style="margin-top: -50px; border-radius: 10px;">
			<table class="table table-condensed">
				...
				<tbody>
					...
					<?php else : ?>
						...
						<div style="font-size: 18px;text-align: center;padding: 6px;">Não foram encontrados productos no carrinho.</div>
					<?php endif; ?>
				</tbody>
			</table>
		...
		<a href="<?= ROOT ?>checkout">
			<input type="button" class="btn btn-warning pull-right" value="Finalizar compra >" style="border-radius: 10px;">
		</a>
		<a href="<?= ROOT ?>shop">
			<input type="button" class="btn btn-warning pull-left" value="< Continuar a comprar" style="border-radius: 10px;">
		</a>
	</div>
</section>
<!--/#cart_items-->
