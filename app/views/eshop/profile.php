...
<section id="main-content">
	<section class="wrapper">
		<div style="min-height: 400px;max-width: 800px;margin: auto;">
			...
			<?php if (is_object($profile_data)) : ?>
				...
				<div class="col-md-3 mb" style="flex:1;background-color: #eee;text-align: center;box-shadow: 0px 0px 20px #aaa; border: solid thin #ddd;">
					<!-- WHITE PANEL - TOP USER -->
					<div class="white-panel pn">
						<div class="white-header" style="color:grey">
							<h5>MY ACCOUNT</h5>
						</div>
						<p><img src="<?= ASSETS . THEME ?>admin/img/eu.jpg" class="img-circle" width="100"></p>
						<p><b><?= $profile_data->name ?></b></p>

						<div class="col-md-12" >
							<p id="user_text" class="small mt">MEMBER SINCE</p>
							<p><?= date("Y-m-d H:i:s", strtotime($profile_data->date)) ?></p>
						</div>
