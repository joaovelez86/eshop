			...
			<div class="col-sm-12">
				<div id="slider-carousel" class="carousel slide" data-ride="carousel">
					...
					<?php if (isset($slider) && is_array($slider)) : ?>
							...
							<?php foreach ($slider as $row) : $num++ ?>
								<div class="item <?= $num == 1 ? 'active' : ''; ?>">
									<div class="col-sm-6">
										...
										<p><?= $row->text ?></p>
										<a href="<?= $row->link ?>">
											<button type="button" class="btn btn-default get">Adicionar ao Carrinho</button>
										</a>
									</div>
									<div class="col-sm-6">
						...
						<a href="#slider-carousel" class="left control-carousel hidden-xs" data-slide="Antes">
							<i class="fa fa-angle-left" style="color: black;"></i>
						</a>
						<a href="#slider-carousel" class="right control-carousel hidden-xs" data-slide="A seguir">
