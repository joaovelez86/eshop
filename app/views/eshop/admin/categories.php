                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
	                  	  	  <h4><i class="fa fa-angle-right"></i> Categorias dos Productos <button class="btn btn-primary btn-xs" onclick="show_add_new(event)"><i class="fa fa-plus"></i> Add New</button></h4>
			                      ...
			                      <form class="form-horizontal style-form" method="post">
			                          ...
			                          <div class="form-group">
			                              <label class="col-sm-2 col-sm-2 control-label">Sub-categoria (opcional):</label>
			                              <div class="col-sm-10">
					            ...
					            <br><br>
				                  ...
				                  <h4 class="mb"><i class="fa fa-angle-right"></i> Edita a Categoria</h4>
			                      <form class="form-horizontal style-form" method="post">
			                          <div class="form-group">
			                              <label class="col-sm-2 col-sm-2 control-label">Nome da Categoria:</label>
			                              <div class="col-sm-10">
			                          ...
			                          <div class="form-group">
			                              ...
			                              <div class="col-sm-10">
              	  	  					...
              	  	  					<button type="button" class="btn btn-warning" onclick="show_edit_category(0,'',event)" style="position:absolute;bottom:10px; left:10px;">Cancelar</button>
              	  	  					<button type="button" class="btn btn-primary" onclick="collect_edit_data(event)" style="position:absolute;bottom:10px; right:10px;">Gravar</button>
                              ...
                              <tr>
                                  <th><i class="fa fa-bullhorn"></i> Categoria</th>
                                   <th><i class=" fa fa-table"></i> Sub-Categoria</th>
